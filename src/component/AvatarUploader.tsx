import { Badge, Tooltip, Fab, Avatar, makeStyles, ButtonBase, Collapse, Dialog, DialogTitle, DialogContent, Button, DialogActions, Typography, Grid, Container, CircularProgress } from '@material-ui/core';
...
const Cropper = ({ src, open = false, onComplete, onCancel = () => {} }: CropperProps) => {
  const classes = useStyles();
  const imgRef = useRef<HTMLImageElement | null>(null);
  const canvasRef = useRef<HTMLCanvasElement | null>(null);
  const [currentCrop, setCurrentCrop] = useState<ReactCrop.Crop>({ unit: '%', x: 35, y: 35, width: 30, aspect: 1 });
